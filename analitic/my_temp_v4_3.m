%%
% Пробую изменить коэффициенты упругости, чтобы она вносила бОльший вклад 
% увеличил вклад упругости в 2 раза. Для сохранения "баланса" умножил
% нормальный коэффициент упругости-поляризации на 2
%%
